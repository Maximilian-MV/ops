export default {
	...
	"background": {
		"primaryGradient": "linear-gradient(180deg,--color-primary 0%,rgba(0,0,0,0) 20.4%,transparent 100%) 0 0 no-repeat",
		"secondaryGradient": "linear-gradient(180deg, --color-secondary, transparent) no-repeat 0 0",
		"axyenna": "#f20000 radial-gradient(circle at center,rgba(0,0,0,0) 0%,rgba(0,0,0,0) 45.6%,rgba(0,0,0,1) 100%) repeat-x"
	},
	"transform": {
		"rotate90": "translate3d(0px, 0px, 0px)",
